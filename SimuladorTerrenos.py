...
def plot_terreno(fichero,poly,color):
    ...
    if(poly == 'lowpoly'):
        ...
        npoly = 5000
        vueltas = 100
    l = lectura_fichero(fichero)    
    alturas, filas, columnas, espaciado = l[0],l[1],l[2],l[3] 
...
archivo = "/home/cesargasca/Desktop/19-1/Computational_Geometry/proyecto/Simulador-de-Terrenos-master/taide.asc"

plot_terreno(archivo,'lowpoly','gnuplot')
print('a')
